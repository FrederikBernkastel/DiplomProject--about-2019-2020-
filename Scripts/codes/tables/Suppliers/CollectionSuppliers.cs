...
{
    public partial class CollectionSuppliers : BaseTable
    {
        public override string RUSNameTable { get { return "Поставщики"; } }
        public override string ENGNameTable { get { return "suppliers"; } }
    ...
    public partial class CollectionSuppliers : BaseTable
    {
        ...
        {
            new ISuppliers().ShowDialog();
        }
        public override void ShowFormUpdateInfo(IEnumerable<BaseData> indexes)
        {
            new USuppliers(indexes.Cast<Provider>()).ShowDialog();
        }
                ...
                case "Устройства":
                    return SelectInfo().Cast<Device>().Where(u =>
                        ...
                        sdf[1] == "Кабинет" ?
                            ...
                            sdf[2] == "Не содержит" ? !u.Cabinet.ToString().Contains(sdf[3]) : true : true).Where(u => u.Provider != null).Select(u => u.Provider);
                default:
        ...
        {
            PrintInfo(view, RUSPrintField, list.Cast<Provider>().Select(u => new string[] 
            {
                u.ID.ToString(),
                u.Name,
                u.FullName,
        ...
        public override IEnumerable<BaseData> SelectInfo()
        {
            foreach (DataRow s in NGDB.SelectInfo(ENGNameTable))
                yield return new Provider().SetDataRow(s);
        }
    }
}
